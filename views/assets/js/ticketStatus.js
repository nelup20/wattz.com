      ...
      success: function(data, textstatus, jqXHR) {
        ...
        if (data === "None found") {
          if (notFound === 0) {
            ...
            $("#ticketStatusContainer").append(
              '<h3 class="btn btn-danger form-control col-xs-12" id="wrongNumberWarning">Ticket not found! Please make sure you put in the correct ticket number.</h3>'
            );
            notFound = 1;
          }
        } else {
          $("#ticketStatusContainer").html(
            "<i class='fa fa-cog fa-spin fa-3x fa-fw' id='loadingIcon'></i>"
          );
